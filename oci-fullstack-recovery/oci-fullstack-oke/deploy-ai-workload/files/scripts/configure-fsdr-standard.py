#!/usr/bin/env python3
"""Create the OKE/ATP Full Stack DR configuration for the FSDR RAG deployment.

This creates the standard FSDR configuration for the AI FSDR lab.
...
def main():
    ...
    primary_details = {
        ...
        "members": [
            {"memberType": "AUTONOMOUS_DATABASE", "memberId": primary_atp},
            {
    ...
    standby_details = {
        ...
        "members": [
            {"memberType": "AUTONOMOUS_DATABASE", "memberId": standby_atp},
            {
    ...
    logger.info("Preparing ATP, OKE, and volume-group members")
